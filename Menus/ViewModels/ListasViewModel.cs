...
public partial class ListasViewModel : ViewModelBase
{
    ...
    [ObservableProperty] private string info2 = string.Empty;
    ...
    public ListasViewModel(NavigationService navigationService)
    {
    ...
    public void SelectedLanguagesChanged()
    {
        ...
        Info = "HAS SELECCIONADO: " + SelectedLanguages.Count + "/4 lenguajes.";
    }

    [RelayCommand]
    public void SelectedEntornosChanged()
    {
        if (SelectedEntornos.Count == 0)
        {
        ...
        Info2 = "HAS SELECCIONADO: " + SelectedEntornos.Count + "/4 entornos.";
    }
